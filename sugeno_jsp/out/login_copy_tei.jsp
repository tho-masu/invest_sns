...
<meta charset="UTF-8">
<title>ログイン画面</title>
<link href="<%=request.getContextPath()%>/sugeno_css/login_copy.css" rel="stylesheet" type="text/css">
...
<div class="container">
	<div class="row login_box">
	    <div class="col-md-12 col-xs-12 img_area" align="center">

            <div class="outter"><img src="<%=request.getContextPath() %>/img/user_icon/default_icon.png" class="image-circle"/></div>
            <h1>Hi Guest</h1>
